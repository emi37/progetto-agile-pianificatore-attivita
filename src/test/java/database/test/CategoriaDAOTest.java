...
/**classe di testing per verificare l'inserimento delle categorie
 */
public class CategoriaDAOTest {
    ...
    public void testInserimentoNuovaCategoria() {
        ...
        // 2. simulo l'inserimento nel database
        Categoria risultato = dao.inserisciCategoriaCustom(nomeCategoria, idUtente);
        
        // 3. faccio l'asserzione: verifico che il db abbia accettato l'inserimento 
        // restituendomi un oggetto Categoria valido (non nullo)
        assertNotNull(risultato, "l'inserimento della categoria ha dato errore");
    }
}